        ...
        <div className="mx-auto max-w-6xl px-4 py-16 lg:px-6 lg:py-24">
          <div className="mx-auto max-w-4xl space-y-8">
            ...
            <p className="text-lg text-slate-300 sm:text-xl lg:text-2xl">
              ...
              Learn from industry experts and join thousands of successful professionals.
            </p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              ...
              <Link href="/courses/linkedin-growth" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-8 py-4 text-lg font-medium text-slate-100 transition hover:border-white/30 hover:bg-white/10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-100">430,000+</span>
                <span>Students</span>
              </div>
              <div className="flex items-center gap-2">
                <Star className="h-5 w-5 text-blue-400" />
                <span className="font-semibold text-slate-100">4.9/5</span>
                <span>Rating</span>
              </div>
              <div className="flex items-center gap-2">
                <Award className="h-5 w-5 text-blue-400" />
                <span className="font-semibold text-slate-100">Industry</span>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 lg:px-6 lg:py-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-50 sm:text-4xl mb-4">
              Why Choose <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Own Your Growth</span>?
            </h2>
      ...
      <footer className="bg-slate-950">
        <div className="mx-auto max-w-6xl px-4 py-8 lg:px-6">
          ...
          <div className="mt-8 border-t border-white/5 pt-8 text-center text-sm text-slate-400">
            © 2024 Own Your Growth. All rights reserved.
          </div>
        </div>
      </footer>
    </main>
